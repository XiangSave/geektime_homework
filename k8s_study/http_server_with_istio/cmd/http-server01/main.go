...
import (
	"os"
	"sample_http_server/internal/httpServer01"
...
func init() {
	...
	err = setupLogger(global.HttpServer.ServiceSetting.LogPath, log.DebugLevel)
	if err != nil {
...
func main() {
	...
	s := server.New(listenAddress, httpServer01.SetHandlers())
